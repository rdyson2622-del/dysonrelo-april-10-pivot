...
function videoFrame(source, side, name, muted = false) {
  ...
  return [
    {
      type: 'shape', shape: 'rectangle', x, y: '85.5%', width: '29%', height: '30%',
      fill_color: '#000000', stroke_color: gold, stroke_width: '0.35 vmin', border_radius: '1.2 vmin',
    },
    {
      name, type: 'video', source, x, y: '85.5%', width: '28%', height: '28%',
...
function charlieScene(clip, index) {
  return {
    ...
    elements: [
      { type: 'image', source: studioBackground, fit: 'cover' },
...
function bobScene(clip, index, charlieSource) {
  ...
  const elements = [
    { type: 'image', source: studioBackground, fit: 'cover' },
    {
      type: 'shape', shape: 'rectangle', x: '47.5%', y: '42%', width: '58%', height: '56%',
      fill_color: '#f5f0e8', stroke_color: gold, stroke_width: '0.4 vmin', border_radius: '1.5 vmin',
    },
    {
      type: 'text', text: 'DNN INTELLIGENCE BUREAU', x: '21%', y: '17%', width: '51%', height: '5%',
