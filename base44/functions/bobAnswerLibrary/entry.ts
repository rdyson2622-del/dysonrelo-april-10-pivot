 ...
 * Bob speaks WITH the listener, not AT them. Suggestions, not directives.
 * "You might consider...", "Many clients have found...", "One approach..."
 */
const SEED = [
  { question: "Who is Bob Dyson?", answerScript: "I'm Bob Dyson. I've spent over fifty-five years in real estate, and I run this relocation program personally. Every client's first step is a conversation with me — not a form, not a call center. Just me." },
  { question: "How do I get started with Dyson & Dyson?", answerScript: "It starts with a free, no-obligation conversation with me. No paperwork, no enrollment forms. You share your situation, and if we're a fit, my team takes it from there. You might reach me at eight five eight, three five three, twelve hundred, or book a session right here on the site." },
  { question: "How do you pick the right agent for me?", answerScript: "We don't hand you a name off a list. What we do is pull production data, interview top performers in your destination market, and select an agent whose track record matches your specific move — your price point, your neighborhood, your timeline. And because they work through us, they stay accountable." },
  ...
  { question: "Do you help with schools for my kids?", answerScript: "We do. School fit is one of the biggest drivers of where a family might land. We research the districts, help arrange tours, and walk you through enrollment paperwork so your kids are set before you even arrive." },
  ...
  { question: "What if I'm not sure where I want to move yet?", answerScript: "That's actually a great place to start. We do city and neighborhood research based on your lifestyle — commute, schools, culture, cost of living. You might consider talking with me before you decide, and we'll narrow it down together." },
  ...
  { question: "Can my employer use your service for employee relocations?", answerScript: "Yes. We work with employers who want their people relocated smoothly without standing up an internal relocation department. You might have your HR team reach out to me directly and we'll set up a program." },
