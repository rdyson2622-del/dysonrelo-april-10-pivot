...
import { getAuthHeader, exportDocText, extractDocId } from '../../shared/claudeLibraryDrive.ts';

/**
 * claudeLibrarySyncDoc — admin-only.
 ...
 * first line if no summary is set). This is the "update Google Doc → Claude
 * updates Base44 metadata" half of Robert's manual sync workflow.
 *
