...
5. BOB_SCRIPT: spoken by Bob/Dyson (the real estate expert). 45-75 seconds (~120-200 words). Explain what the news means for buyers, sellers, homeowners, or relocating families. Practical, calm, expert. No "that's a great question." No "absolutely." Direct, conversational. Do not invent statistics — only use numbers present in the provided source material.
