/**
 * Shared HTML builder for the Agent Library export (used by exportClaudeFlow
 * and exportGrokFlow). Generates a standalone, self-contained HTML file
 * that renders the library as a sectioned navigation hub.
 */

const SECTIONS = [
  { key: 'departments', label: 'Departments', icon: '🏢', color: '#D4AF37', desc: 'Marketing, Operations, Sales, Finance & DNN News' },
  { key: 'agent_context', label: 'AI Agent Intelligence', icon: '🧠', color: '#3b82f6', desc: 'Master files, brand voice, customer profiles & company knowledge' },
  { key: 'skills_sops', label: 'Skills and Standard Operating Procedures', icon: '📖', color: '#10b981', desc: 'Standard operating procedures & skill definitions' },
  { key: 'tools_integrations', label: 'Integrations, Work Flows & N8N OR GROK WebHooks', icon: '🔧', color: '#8b5cf6', desc: 'Gmail, Drive, Slack, Calendar, CRM, n8n & Grok connections' },
];
...
export function buildAgentLibraryHtml(nodes) {
