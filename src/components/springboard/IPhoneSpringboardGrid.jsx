      ...
      {apps.map((app) => {
        ...
        return (
          ...
          >
            ...
            >
              {/* iOS Glass Gloss Sheen (Top Half) */}
              ...
              {/* Authentic Red iOS Circular Notification Count Badge (from user iPhone screenshot) */}
              {app.badgeCount && (
                <span 
            ...
            {/* Line 1: iOS App Label directly below icon in crisp white font */}
            ...
            {/* Line 2: Possible copy below (as requested by user) */}
            {showCopy && app.copy && (
