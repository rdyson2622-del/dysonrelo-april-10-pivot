...
export default function ChiefPilotSidebar({ workspace }) {
  return (
    <aside className="flex min-h-0 flex-col gap-4 border-b border-white/10 p-5 md:border-b-0 md:border-r">
      <div className="flex items-center gap-2"><span className="text-[10px] tracking-[0.18em] text-dyson-text">DYSON HOMES</span><CopilotWordmark className="h-7 w-16" /></div>
