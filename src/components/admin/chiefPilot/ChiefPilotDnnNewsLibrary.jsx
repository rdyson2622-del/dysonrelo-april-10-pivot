...
export default function ChiefPilotDnnNewsLibrary({ stories, copilotSeries = [], onBack }) {
  return (
    <div className="mx-auto w-full max-w-4xl text-center">
      ...
      {stories.length === 0 ? (
        ...
        <p className="mt-16 text-xs tracking-widest text-dyson-gold-deep">THE COPILOT SERIES</p>
        <h2 className="mt-2 text-3xl font-normal text-dyson-text-dark">The CoPilot Series of Explainer Videos</h2>
