...
export default function ChiefPilotPropertySearch({ title, activeProperty, isExample, exampleLoading, onHideExample, onSearchOwn, searchLoading, searchError, onSearch, onClear }) {
  ...
  return (
    <div className="flex min-h-full flex-col">
      <header className="text-center"><p className="mb-3 text-xs text-dyson-taupe">{title}</p><CopilotWordmark className="mx-auto mb-3 h-14 w-36 brightness-125 saturate-125" /><p className="mt-2 text-sm text-dyson-taupe">Private real estate intelligence, organized around the property.</p></header>
