  ...
  return (
    <div className="grid min-h-full items-start gap-10 py-8 text-white lg:grid-cols-[1.2fr_0.8fr]">
      <div className="flex flex-col items-center text-center">
        <div className="flex items-end gap-3"><span className="pb-2 font-serif text-3xl font-light text-white">meet</span><div className="flex flex-col items-center"><DysonVerticalBadge height={82} className="mb-2" /><CopilotWordmark bold className="h-16 w-52" /></div></div>
