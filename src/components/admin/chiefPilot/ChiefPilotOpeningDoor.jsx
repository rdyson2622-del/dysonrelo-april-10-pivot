  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <div className="w-full pt-6">
        ...
        <p className="mt-7 text-center text-lg font-semibold text-dyson-text-dark">INTERVIEW US! (858) 353 1200</p>
        <p className="mt-6 flex items-center gap-2 text-xs text-dyson-text-dark"><ShieldCheck className="h-4 w-4" />Independent research — no spam calls or agent involvement.</p>
      </div>
    </div>
  );
}