  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <div className="w-full pt-6">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-2"><span className="text-xs text-dyson-gold-light">Testimonial:</span><a href={TESTIMONIAL_VIDEO_URL} target="_blank" rel="noopener noreferrer" className="rounded-md border border-white/20 bg-white/5 px-3 py-1 text-xs text-white hover:border-dyson-gold-light">Windean Strattons — Arizona to Arkansas Move</a></div>
