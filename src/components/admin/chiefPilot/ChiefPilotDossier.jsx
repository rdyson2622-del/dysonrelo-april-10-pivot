...
export default function ChiefPilotDossier({ mode, isChatsInbox, libraryItems, subject, activeProperty, isExample, showExample, onHideExample, selectedAgentName, onOpenEntry, onSend, messages = [], loading = false, error = '' }) {
  if (mode === 'library') {
