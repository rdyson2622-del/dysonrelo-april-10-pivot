...
export default function ChiefPilotPageTwo() {
  ...
  return (
    <section className="h-[calc(100vh-220px)] min-h-[680px] overflow-hidden rounded-xl bg-dyson-cream p-3" style={{ backgroundColor: 'var(--dyson-cream)' }}>
      <div className="grid h-full gap-3 overflow-hidden md:grid-cols-[240px_1fr]">
        <ChiefPilotSidebar workspace={workspace} />
        <div id="chief-pilot-content" className="h-full overflow-y-auto rounded-lg border border-white/10 bg-dyson-ink p-7 sm:p-10">
