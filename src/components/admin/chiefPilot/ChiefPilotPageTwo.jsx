...
export default function ChiefPilotPageTwo() {
  ...
  return (
    <section className="h-[calc(100vh-220px)] min-h-[680px] overflow-hidden rounded-xl border border-white/10 bg-dyson-cream">
      <div className="grid h-full md:grid-cols-[240px_1fr]">
        <ChiefPilotSidebar workspace={workspace} />
        <div id="chief-pilot-content" className="h-full overflow-y-auto bg-dyson-cream p-7 sm:p-10">
