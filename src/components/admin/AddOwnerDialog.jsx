        ...
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input value={form.owner_name} onChange={(e) => update('owner_name', e.target.value)} placeholder="John Smith" />
            </div>
            <div>
              <Label>Phone</Label>
          ...
          <div>
            <Label>Email</Label>
            <Input value={form.email} onChange={(e) => update('email', e.target.value)} placeholder="john@email.com" />
          </div>
          <div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              <Label>City</Label>
              <Input value={form.property_city} onChange={(e) => update('property_city', e.target.value)} placeholder="Austin" />
            </div>
            <div>
              <Label>State</Label>
              <Input value={form.property_state} onChange={(e) => update('property_state', e.target.value)} placeholder="TX" />
            </div>
            <div>
              <Label>Listing Price</Label>
              <Input type="number" value={form.listing_price} onChange={(e) => update('listing_price', e.target.value)} placeholder="450000" />
            </div>
          </div>
          <div>
            <Label>Moving To</Label>
            <Input value={form.moving_to} onChange={(e) => update('moving_to', e.target.value)} placeholder="Where are they relocating?" />
          </div>
          <div>
            <Label>Notes</Label>
