...
const NAV_SECTIONS = [
  {
    ...
    children: [
      ...
      { label: '🛠️ Preferred Vendors', path: '/admin/preferred-vendors', icon: Wrench, highlight: true },
  ...
  },
  {
    ...
    children: [
      ...
      { label: '📝 Charlie Conversations (Transcripts)', path: '/admin/charlie-conversations', icon: MessageCircle, highlight: true },
