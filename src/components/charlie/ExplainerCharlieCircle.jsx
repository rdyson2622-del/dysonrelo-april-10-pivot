...
/**
 * ExplainerCharlieCircle — Charlie-only video circle for the Explainers page.
 * Uses HeyGen-rendered clips from the ExplainerClip entity.
...
export default function ExplainerCharlieCircle() {
  ...
  const { data: clips = [] } = useQuery({
    queryKey: ['explainerClips'],
    queryFn: () => base44.entities.ExplainerClip.list(),
  });
