...
const SERVICES = [
  ...
  },
  {
    ...
    tagline: 'We match you with the right agent. Not just any agent.',
    description: 'Our network spans every major US city. We vet agents on performance, local knowledge, and client communication. You get introduced — we handle the rest.',
    highlight: '100% FREE to you — agent fees are paid at close',
    cta: 'See How Agent Matching Works',
    link: '/find-agent',
    preview: [
  ...
  },
  {
    ...
    cta: 'See Property Comparison Tool',
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 pb-20 space-y-6">
      ...
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-white">Your Full-Service Dashboard</h2>
