    ...
    <div className="h-screen overflow-hidden bg-dyson-black p-3 sm:p-4">
      <div className="mx-auto flex h-[calc(100vh-32px)] max-w-7xl flex-col gap-3 md:flex-row">
        ...
        <div className="min-h-0 flex-1 overflow-hidden rounded-lg bg-dyson-black">
          <div id="chief-pilot-content" className={`h-full overflow-y-auto rounded-lg border p-4 sm:p-7 md:p-10 ${workspace.entryOpen ? 'border-black/10 bg-dyson-cream' : (workspace.mode !== 'news' && workspace.mode !== 'library') ? 'border-white/10 bg-dyson-black' : 'border-black/10 bg-dyson-cream'}`}>
            {workspace.entryOpen ? (
