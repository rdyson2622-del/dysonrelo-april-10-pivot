...
import { ArrowLeft, Search, MapPin, GraduationCap, DollarSign, Heart, Building2, TreePine, MessageCircle, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen" style={{ background: '#f8f8f8' }}>
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500">Enter a destination city, then tap any category to get AI-powered research from Charlie.</p>
        </div>
        ...
        <AnimatePresence>
          {loading && (
            ...
            >
              ...
              <p className="text-sm font-semibold text-slate-700">Charlie is researching <span style={{ color: GOLD }}>{selectedCategory?.label}</span> in {submittedCity}...</p>
          ...
          {result && !loading && (
            ...
            >
              ...
              <div className="mt-6 p-4 rounded-xl" style={{ background: '#0d0d0d', border: `1px solid ${GOLD}` }}>
                <p className="text-sm font-semibold mb-1" style={{ color: '#fff' }}>Want a personalized guide for your move to {submittedCity}?</p>
                <p className="text-xs mb-3" style={{ color: 'rgba(255,255,255,0.7)' }}>Charlie can build your complete relocation plan — neighborhoods, agents, schools, utilities — all tailored to your family.</p>
                <Link to="/Chat">
        ...
        {/* Empty state — no city entered yet */}
        {!cityReady && !loading && (
