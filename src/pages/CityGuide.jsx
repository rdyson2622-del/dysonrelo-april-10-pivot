        ...
        {committed === false && committed !== null && (
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
            ...
            <div className="text-center">
              ...
              <h1 className="text-4xl font-bold mb-3" style={{ color: '#111' }}>Here's What's Coming For You</h1>
        ...
        {committed === true && (
          <div>
            <div className="text-center mb-8">
              <p className="text-xs font-bold tracking-[0.3em] mb-2" style={{ color: GOLD }}>CITY GUIDE</p>
              <h1 className="text-4xl font-bold mb-2" style={{ color: '#111' }}>Research Your New City</h1>
