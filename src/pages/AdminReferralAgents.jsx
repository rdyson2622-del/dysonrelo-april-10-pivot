...
import { Plus, Edit2, Check, X, Trash2, Handshake, ExternalLink, Upload, Phone, MessageSquare, Mail, Video, FileText, Workflow, Users, FileSignature, Radio, Megaphone } from 'lucide-react';
    ...
    <div className="min-h-screen px-6 py-8" style={{ background: '#ede0cc' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6 flex-wrap">
          ...
          <a href="/admin/referral-weekly-campaign"
            className="flex items-center gap-2 px-4 py-2 rounded-full font-bold text-xs transition-all hover:scale-[1.02]"
            style={{ background: '#fff8ee', border: `1px solid ${GOLD}60`, color: '#1a1a1a' }}>
            <Megaphone className="w-3.5 h-3.5" style={{ color: GOLD }} /> Weekly Campaign
          </a>
