...
export default function Home() {
  return (
    <div className="min-h-screen" style={{ background: '#808080', color: '#fff' }}>
      ...
      <section id="103" className="relative py-16 px-6 md:px-14" style={{ background: '#000', borderTop: '1px solid rgba(212,175,55,0.15)', borderBottom: '1px solid rgba(212,175,55,0.15)', position: 'relative' }}>
          ...
          <div className="relative grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="leading-relaxed mb-6" style={{ color: '#e5e5e5' }}>
                Before we show you a single name, Charlie interviews you on the <em>type</em> of agent you'd work best with — communication style, personality, pace. Then we pull from the <strong style={{ color: '#fff' }}>top 20 agents in your destination market</strong>, review their production records, check their DRE standing, and personally vet each one against Bob Dyson's 40+ years of market expertise. From that pool, we present you with <strong style={{ color: '#fff' }}>3 to 5 curated candidates</strong> — never more, never less.
              </p>
