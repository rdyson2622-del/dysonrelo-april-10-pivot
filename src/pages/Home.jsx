      ...
      <section className="relative overflow-hidden" style={{ minHeight: '100vh', background: '#808080' }}>
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-center gap-12 px-6 md:px-14 w-full h-full" style={{ minHeight: '100vh' }}>
          ...
          >
            ...
            <h1 className="display-heading" style={{ fontSize: 'clamp(1.2rem, 4vw, 4rem)', lineHeight: 1.15, letterSpacing: '0.28em', marginBottom: '1.5rem', textAlign: 'center', whiteSpace: 'nowrap' }}>
              <span style={{ color: '#D4AF37' }}>CONCIERGE</span>
              <span style={{ color: '#000', textTransform: 'none', marginLeft: '0.4em' }}>Real Estate</span>
            </h1>
