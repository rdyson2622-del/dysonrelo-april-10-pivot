      ...
      <div className="w-full px-8 pb-20 pt-4" style={{ background: '#ede0cc' }}>
        ...
        <div className="w-full mt-12 text-left">
          ...
          >
            ...
            <p className="leading-relaxed mb-3" style={{ color: '#1a1a1a', fontFamily: 'Georgia, serif', fontSize: '0.97rem' }}>
            ...
            <p className="leading-relaxed mb-8" style={{ color: '#1a1a1a', fontFamily: 'Georgia, serif', fontSize: '0.97rem' }}>
            ...
            <p className="leading-relaxed mb-5" style={{ color: '#1a1a1a', fontFamily: 'Georgia, serif', fontSize: '0.97rem' }}>
            ...
            <blockquote className="rounded-2xl px-6 py-6 mb-8 relative"
              ...
              <span className="text-5xl absolute top-2 left-4 leading-none" style={{ color: GOLD, opacity: 0.3, fontFamily: 'Georgia, serif' }}>"</span>
              <p className="leading-relaxed italic pt-3" style={{ color: '#1a1a1a', fontFamily: 'Georgia, serif', fontSize: '0.97rem' }}>
              ...
              <p className="leading-relaxed italic mt-4" style={{ color: '#1a1a1a', fontFamily: 'Georgia, serif', fontSize: '0.97rem' }}>
            ...
            <p className="leading-relaxed" style={{ color: '#1a1a1a', fontFamily: 'Georgia, serif', fontSize: '0.97rem' }}>
