...
import {
  ...
  Trash2, RefreshCw, Clock, CheckCircle2, XCircle, BarChart2,
  ChevronRight, Layers
} from 'lucide-react';
...
// ─── TAB: COMPOSE ───────────────────────────────────────────────────────────
function ComposeTab({ templates, owners }) {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-1 space-y-4">
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          ...
          {templates.length === 0 && (
            <p className="text-sm text-slate-400 italic">No SMS templates found. Go to Admin → Templates to create one.</p>
          )}
  ...
  return (
    <div className="p-6 min-h-screen bg-slate-50">
      <div className="max-w-6xl mx-auto">
        ...
        {tab === 'compose' && <ComposeTab templates={uniqueTemplates} owners={owners} />}
