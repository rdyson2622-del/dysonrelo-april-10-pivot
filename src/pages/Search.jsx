  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#808080' }}>
      <main className="flex-1 flex items-center justify-center p-6">
        ...
        >
          <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69b57d0bb4c61271a073eceb/fa3407553_Screenshot2026-02-20at90227PM.png" alt="Dyson & Dyson" className="w-auto mx-auto mb-6" style={{ height: '84px' }} />
