    ...
    <div className="min-h-screen" style={{ background: '#0d0d0d', color: '#fff' }}>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-8 md:px-16 py-20 text-center"
        ...
        <div className="max-w-2xl space-y-5">
          ...
          <p className="text-base italic leading-relaxed" style={{ color: 'rgba(255,255,255,0.65)' }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-4xl">
          {[
            ...
            <div key={i} className="p-4 rounded-2xl flex flex-col items-center text-center gap-3"
              ...
              <p className="font-bold text-sm" style={{ color: '#fff' }}>{s.title}</p>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-8 md:px-16 py-20 text-center"
        ...
        <div className="max-w-2xl space-y-5 text-left">
          <p className="text-lg leading-relaxed text-center" style={{ color: '#fff' }}>
            Seeing the full scope of what's ahead can feel overwhelming.
          </p>
          <div className="rounded-2xl p-8" style={{ background: 'rgba(212,175,55,0.05)', border: '1px solid rgba(212,175,55,0.3)' }}>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-8 md:px-16 py-20 text-center"
        ...
        <div className="max-w-xl w-full space-y-3 text-left">
          <p className="text-base leading-relaxed mb-6 text-center" style={{ color: '#fff' }}>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-8 md:px-16 py-20 text-center"
        ...
        <div className="space-y-4 max-w-md">
          <p className="text-base" style={{ color: '#fff' }}>The Dyson &amp; Dyson Companies, Inc.</p>
          <p className="text-base font-bold" style={{ color: GOLD }}>California Department of Real Estate #02303118</p>
          <p className="text-lg" style={{ color: '#fff' }}>Concierge Relocation Program • Free to Buyers</p>
          <p className="text-2xl font-black" style={{ color: GOLD }}>(858) 353-1200</p>
          <p className="text-sm mt-6" style={{ color: 'rgba(255,255,255,0.45)' }}>55 years of relocation management expertise.</p>
        </div>
      </section>
