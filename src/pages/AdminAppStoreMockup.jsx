            ...
            <div className="flex flex-col lg:flex-row w-full min-h-[640px]">
              ...
              >
                <div className="space-y-3">
                  ...
                  {/* ========================================================
                      CONCIERGE TO-DO'S: APPLE-STYLE PILLS
                      Each item has an Apple glossy squircle icon tile,
                      crisp title, purpose subtitle, and native iOS pill badge!
                      ======================================================== */}
                  <div className="space-y-1.5 pt-1">
                    ...
                    {/* 1. Talk with Charlie (Apple Pill) */}
                    <div 
                      onClick={() => navigate('/talking-app')}
                      className="p-2 sm:p-2.5 rounded-2xl bg-[#ede0cc] text-[#0a0a0a] hover:bg-[#f6efe3] transition-all cursor-pointer shadow-md border border-black/15 flex items-center justify-between gap-2.5 group active:scale-98"
                    >
                      <div className="flex items-center gap-2.5 min-w-0">
                        {/* Apple Squircle Icon */}
                        <div className="w-9 h-9 rounded-[13px] bg-gradient-to-br from-[#064e3b] via-[#0d281e] to-[#0a0a0a] border border-[#10b981]/50 flex items-center justify-center shrink-0 shadow relative overflow-hidden">
                        ...
                        <div className="min-w-0 leading-tight text-left">
                          ...
                          <p className="text-[9.5px] text-[#554433] truncate mt-0.5">
                            Live voice AI concierge &amp; vetting
                          </p>
                        </div>
                      </div>
                    ...
                    {/* 2. Relocating Families & Buyers (Apple Pill) */}
                    <div 
                      onClick={() => navigate('/relocation-intake')}
                      className="p-2 sm:p-2.5 rounded-2xl bg-[#ede0cc] text-[#0a0a0a] hover:bg-[#f6efe3] transition-all cursor-pointer shadow-md border border-black/15 flex items-center justify-between gap-2.5 group active:scale-98"
                    >
                      <div className="flex items-center gap-2.5 min-w-0">
                        <div className="w-9 h-9 rounded-[13px] bg-gradient-to-br from-[#2e2617] via-[#17140f] to-[#0a0a0a] border border-[#D4AF37]/50 flex items-center justify-center shrink-0 shadow relative overflow-hidden">
                          <div className="absolute inset-x-0 top-0 h-1/2 bg-white/20 rounded-t-[13px]" />
                    ...
                    {/* 3. Corporate HR & Employers (Apple Pill) */}
                    <div 
                      onClick={() => navigate('/corporate-relo')}
                      className="p-2 sm:p-2.5 rounded-2xl bg-[#ede0cc] text-[#0a0a0a] hover:bg-[#f6efe3] transition-all cursor-pointer shadow-md border border-black/15 flex items-center justify-between gap-2.5 group active:scale-98"
                    >
                      <div className="flex items-center gap-2.5 min-w-0">
                        <div className="w-9 h-9 rounded-[13px] bg-gradient-to-br from-[#332a18] via-[#1a160d] to-[#0a0a0a] border border-[#e8c84a]/50 flex items-center justify-center shrink-0 shadow relative overflow-hidden">
                          <div className="absolute inset-x-0 top-0 h-1/2 bg-white/20 rounded-t-[13px]" />
                    ...
                    {/* 4. Agents & Brokerages (Apple Pill) */}
                    <div 
                      onClick={() => navigate('/broker-portal')}
                      className="p-2 sm:p-2.5 rounded-2xl bg-[#ede0cc] text-[#0a0a0a] hover:bg-[#f6efe3] transition-all cursor-pointer shadow-md border border-black/15 flex items-center justify-between gap-2.5 group active:scale-98"
                    >
                      <div className="flex items-center gap-2.5 min-w-0">
                        <div className="w-9 h-9 rounded-[13px] bg-gradient-to-br from-[#172554] via-[#0f172a] to-[#0a0a0a] border border-[#3b82f6]/50 flex items-center justify-center shrink-0 shadow relative overflow-hidden">
                          <div className="absolute inset-x-0 top-0 h-1/2 bg-white/20 rounded-t-[13px]" />
                    ...
                    {/* 5. Refer a Client or Colleague (Apple Pill) */}
                    <div 
                      onClick={() => navigate('/refer')}
                      className="p-2 sm:p-2.5 rounded-2xl bg-[#ede0cc] text-[#0a0a0a] hover:bg-[#f6efe3] transition-all cursor-pointer shadow-md border border-black/15 flex items-center justify-between gap-2.5 group active:scale-98"
                    >
                      <div className="flex items-center gap-2.5 min-w-0">
                        <div className="w-9 h-9 rounded-[13px] bg-gradient-to-br from-[#2b2210] via-[#17130b] to-[#0a0a0a] border border-[#D4AF37]/50 flex items-center justify-center shrink-0 shadow relative overflow-hidden">
                          <div className="absolute inset-x-0 top-0 h-1/2 bg-white/20 rounded-t-[13px]" />
                        ...
                        <div className="min-w-0 leading-tight text-left">
                          ...
                          <p className="text-[9.5px] text-[#554433] truncate mt-0.5">
                            Submit buyer, seller or agent lead
                          </p>
                        </div>
                      </div>
                  ...
                  {/* ========================================================
                      DETAILED SYSTEMS: APPLE-STYLE PILLS
                      ======================================================== */}
                  <div className="space-y-1.5 pt-1">
                    <div className="flex items-center justify-between text-[10px] font-black uppercase tracking-wider text-[#D4AF37] px-1">
                    ...
                    >
                      <div className="flex items-center gap-2.5 min-w-0">
                        <div className="w-9 h-9 rounded-[13px] bg-gradient-to-br from-[#450a0a] via-[#1f0a0a] to-[#0a0a0a] border border-[#ef4444]/50 flex items-center justify-center shrink-0 shadow relative overflow-hidden">
                          <div className="absolute inset-x-0 top-0 h-1/2 bg-white/20 rounded-t-[13px]" />
                ...
                <div 
                  className="p-2.5 rounded-2xl flex items-center justify-between gap-2 shadow-inner border border-black/10 mt-2"
                  style={{ background: '#ede0cc', color: '#0a0a0a' }}
                >
                  <div className="min-w-0">
                    <div className="text-[8.5px] font-black uppercase tracking-wider text-[#854d0e] flex items-center gap-1">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#10b981]" />
                      <span>CONCIERGE DIRECT</span>
                    </div>
                    <div className="font-mono text-xs sm:text-sm font-bold text-[#0a0a0a]">
                      (858) 353–1200
                    </div>
                  </div>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="p-4 sm:p-5 rounded-3xl bg-[#0a0a0a] border border-[#D4AF37]/50 shadow-xl space-y-3 text-left">
              ...
              <div className="p-4 rounded-2xl bg-[#ede0cc] border border-[#D4AF37]">
                <div className="grid grid-cols-3 gap-4">
                  {PLATFORM_APP_CATALOG.slice(0, 6).map((app) => {
                    ...
                    return (
                      ...
                      >
                        <div 
                          className={`w-14 h-14 rounded-[18px] bg-gradient-to-br ${app.bgGradient} border ${app.border} flex items-center justify-center shadow-lg group-hover:scale-105 active:scale-95 transition-all relative overflow-hidden`}
                        >
                          <div className="absolute inset-x-0 top-0 h-1/2 bg-white/20 rounded-t-[18px]" />
                          <Icon className="w-6 h-6 drop-shadow" style={{ color: app.iconColor }} />
                        </div>
                        <span className="mt-1 text-[11px] font-bold text-[#0a0a0a] truncate max-w-[85px] leading-tight">
                          {app.shortLabel}
                        </span>
                        <span className="text-[8.5px] text-[#554433] truncate max-w-[85px]">
                          {app.badge}
                        </span>
                      </div>
                    );
