...
export class GeminiLiveSessionClient {
  ...
  async speakOpeningGreeting() {
    const greetingText = "Hi — I'm Charlie, DysonRelo's AI relocation guide. I'm here to learn your move and get you to a human specialist. What's your destination city?";
