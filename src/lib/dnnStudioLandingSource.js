// Locked, permanent snapshot of the verified src/pages/DnnStudioLanding.jsx
// source code. This is a REFERENCE COPY ONLY — viewed on its own admin page
// (never on the live landing page itself) so the correct, working version
// can always be recovered without hunting for it again.
export const DNN_STUDIO_LANDING_SOURCE = `import React, { useState, useEffect } from 'react';
