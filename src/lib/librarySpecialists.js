...
export const LIBRARY_SPECIALISTS = [
  ...
  },
  {
    ...
    scope: 'dysonrelo',
    oneLiner: 'Gmail, Drive, Slack, Calendar, CRM, BoldTrail, n8n, and Grok/Cursor webhooks.',
    ...
    adminPaths: ['/admin/claude-flow', '/connect', '/admin/dnn/show-pipeline', '/admin/wisdom/escrow'],
    owns: [
      'Gmail Integration',
      'Google Drive Sync',
      'Slack Notifications',
      'Calendar Management',
      'CRM Connections',
      'BoldTrail / Wisdom Back Office secrets (names only)',
